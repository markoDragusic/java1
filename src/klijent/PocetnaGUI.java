...
//            System.out.println("Dogadjaj selektovan za brisanje " + nazivDogadjaja);
                        System.out.println("WRITE OBJECT prije");

            oos.writeObject(new Poruka(Poruka.IDPoruke.BRISANJE_DOGADJAJA, nazivDogadjaja));//s
                        System.out.println("WRITE OBJECT poslije");

                                                System.out.println("READ OBJECT prije");

            Poruka poruka = (Poruka)ois.readObject();
                                                            System.out.println("READ OBJECT poslije");
    ...
    private static void popuniTabeluDogadjaja(ArrayList<Dogadjaj> dogadjaji, JTable tabelaDogadjaji) {
