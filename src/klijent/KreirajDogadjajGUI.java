...
public class KreirajDogadjajGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        organizatorDogadjajaComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));

        ucesnikDogadjajaComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        ...
        jButton1.setText("Dodaj ucesnika");
        ...
        predavacDogadjajComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
                        ...
                        .addGroup(gornjiPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(gornjiPanelLayout.createSequentialGroup()
                                .addGroup(gornjiPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(datumDogadjajaDateChooser, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addGroup(gornjiPanelLayout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(gornjiPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 386, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void zavrsiKreiranjeDogadjajaDugmeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_zavrsiKreiranjeDogadjajaDugmeActionPerformed
        try {
            String porukaServeru = nazivDogadjajaTextField.getText();
            oos.writeObject(porukaServeru);
            String porukaSaServera = (String) ois.readObject();
            System.out.println(porukaSaServera);
            opisDogadjajaTextField.setText(porukaSaServera);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
